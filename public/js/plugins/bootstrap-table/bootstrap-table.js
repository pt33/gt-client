...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        if (!this.options.showHeader || this.options.cardView) {
            ...
            this.$tableLoading.css('top', this.$header.outerHeight() + 100);
    ...
    BootstrapTable.prototype.initData = function (data, type) {
        ...
        //     this.$container.find('.no-records-found').show()
        // } else {
        //     this.$container.find('.no-records-found').hide()
        // }
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        // show no records
        if (!hasTr && this.options.data.length == 0 && nodatashow) {
            trFragments.append('<tr class="no-records-found" style="font-size: 24px;font-style: italic;color: #888;font-weight: 600;">' +
    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        ...
        request = $.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            success: function (res) {
                ...
                // that.$container.loading('destroy');
