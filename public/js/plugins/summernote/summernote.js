        ...
        this.insertImage = function (src, param) {
            return async.createImage(src, param).then(function ($image) {
                ...
                if (typeof param === 'function') {
                    ...
                    var sHeight
                    if (width > height) {
                        sWidth = Math.min($editable.width(), width)
                        sHeight = Math.ceil((height / width) * sWidth)
                    } else {
                        sHeight = Math.min(600, height)
                        sWidth = Math.ceil(width / height) * sHeight
                    }
                    ...
                    context.drawImage($image[0], sx, sy, dWidth, dHeight, dx, dy, sWidth, sHeight);
                ...
                // $image.parents('p').first().attr('align', 'center');
    ...
    var ImageDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body = '<div class="form-group note-form-group note-group-select-from-files">' +
                ...
                imageLimitation +
                '</div>' +
                '<div class="form-group note-group-image-url" style="overflow:auto;display: none;">' +
