...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="icon-file-text"></i>&nbsp;&nbsp;';
            tCaption = '<div tabindex="500" class="sm-form-control file-caption {class}">\n' +
        ...
        _renderButton: function (type) {
            ...
            if (!$h.isEmpty(label)) {
                label = ' <span class="' + self.buttonLabelClass + '" style="position: relative;top:-1px;font-weight: 500;">' + label + '</span>';
            }
            return tmplt.setTokens({
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-sm btn-default btn-outline-secondary',
            fullscreen: 'btn btn-sm btn-default btn-outline-secondary',
            borderless: 'btn btn-sm btn-default btn-outline-secondary',
            close: 'btn btn-sm btn-default btn-outline-secondary'
        },
