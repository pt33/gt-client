...
(function(factory) {
  ...
  $.extend(Loading.prototype, {
     ...
     */
      ...
      var overlay = $('<div class="loading-overlay loading-theme-' + this.settings.theme + '"><div class="loader">' + this.settings.message + '</div></div>')
    ...
    resize: function() {
      ...
      this.overlay.css({
        ...
        width: totalWidth,
        height: totalHeight
          // backgroundColor: 'rgba(238, 238, 238, 0.72)'
      });
    },
